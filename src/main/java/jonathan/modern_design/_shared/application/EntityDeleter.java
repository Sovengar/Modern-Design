package jonathan.modern_design._shared.application;
...
import jonathan.modern_design._shared.infra.repositories.DeletedRowSpringJpaRepo;
...
public class EntityDeleter {
    private final DeletedRowSpringJpaRepo deletedRowSpringJpaRepo;
    ...
    public <T> void saveDeletedEntity(T entity, String originTable, String originId, String deletedBy, String reason) {
        ...
        try {
            ...
            deletedRowSpringJpaRepo.save(deletedRow);
    ...
    public <T> Optional<T> getDeletedEntity(String originTable, String originId, Class<T> entityClass) {
        try {
            return deletedRowSpringJpaRepo.findByOriginTableAndOriginId(originTable, originId)
                    .map(deletedRow -> {
                        try {
