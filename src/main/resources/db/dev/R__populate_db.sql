...
insert into BANKING.ACCOUNTS (account_id, account_number, balance, currency, address, status, version, created_at, created_by) values
(nextval('BANKING.ACCOUNTS_SQ'), 'f5e4e2a8-7f07-4b2e-9b7c-6c6b1fcd3c42', 1000, 'EUR', 'My house', 'ACTIVE', 0, '2025-02-05 14:00:00', 'SYSTEM'),
(nextval('BANKING.ACCOUNTS_SQ'), '56fa9d40-19ee-4c30-9438-33d364bafef9', 600, 'EUR', 'My house', 'ACTIVE', 0, '2025-02-05 14:00:00', 'SYSTEM'),
(nextval('BANKING.ACCOUNTS_SQ'), '3a263b30-d80d-42d4-b64a-2243d258467f', 100, 'EUR', 'My house', 'INACTIVE', 0, '2025-02-05 14:00:00', 'SYSTEM');
