...
insert into BANKING.ACCOUNT_HOLDERS (account_holder_id, name, personal_id_value, personal_id_type, country, birthdate, phone_numbers, user_id, version, created_at, created_by) values
...
insert into BANKING.ACCOUNTS (account_id, account_number, balance, currency, address, status, user_id, version, created_at, created_by) values
(nextval('BANKING.ACCOUNTS_SQ'), 'f5e4e2a8-7f07-4b2e-9b7c-6c6b1fcd3c42', 1000, 'EUR', 'My house', 'ACTIVE', 'f5e4e2a8-7f07-4b2e-9b7c-6c6b1fcd3c42', 0, '2025-02-05 14:00:00', 'SYSTEM'),
(nextval('BANKING.ACCOUNTS_SQ'), '56fa9d40-19ee-4c30-9438-33d364bafef9', 600, 'EUR', 'My house', 'ACTIVE', '56fa9d40-19ee-4c30-9438-33d364bafef9', 0, '2025-02-05 14:00:00', 'SYSTEM'),
(nextval('BANKING.ACCOUNTS_SQ'), '3a263b30-d80d-42d4-b64a-2243d258467f', 100, 'EUR', 'My house', 'INACTIVE', '3a263b30-d80d-42d4-b64a-2243d258467f', 0, '2025-02-05 14:00:00', 'SYSTEM');
